...
Catch 
  {
  "The installation of $packageName failed, please see installer log files at `"C:\Program Files\Microsoft SQL Server\100\Setup Bootstrap\Log`" and `"$InstallerLogLocation`" for more details." | write-host -foregroundcolor yellow
  }